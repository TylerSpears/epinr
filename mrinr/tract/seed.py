...
def get_topk_starting_peaks(
    ...
    within_batch_pair_arc_len = mrinr.coords.antipodal_unit_sphere_arc_len(
    ...
    proj_theta_phi = mrinr.coords.antipodal_sphere_coords(
        theta=peak_theta, phi=peak_phi
    )
    ...
    antipodal_topk_theta, antipodal_topk_phi = mrinr.coords.antipodal_sphere_coords(
        topk_theta, topk_phi
    )
