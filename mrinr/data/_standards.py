...
__all__ = [
    ...
    "HCP_STANDARD_3T_VOX2WORLD_AFFINE",
]

# MNI 152 1mm template space
MNI152_1MM_VOX2WORLD_AFFINE = torch.Tensor(
    [
        [-1, 0, 0, 90],
        [0, 1, 0, -126],
        [0, 0, 1, -72],
...
MNI152_1MM_VOX_SIZE = (182, 218, 182)
MNI152_1MM_FOV_BB = torch.Tensor([[-91, -126, -72], [90, 91, 109]]).to(torch.float32)

# HCP 3T diffusion MRI standards
...
HCP_STANDARD_3T_VOX2WORLD_AFFINE = torch.Tensor(
    [
        [-1.25, 0.0, 0.0, 90.0],
        [0.0, 1.25, 0.0, -126.0],
        [0.0, 0.0, 1.25, -72.0],
